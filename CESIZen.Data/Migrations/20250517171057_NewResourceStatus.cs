...
{
    /// <inheritdoc />
    public partial class NewResourceStatus : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RessourcesRead = table.Column<int>(type: "int", nullable: false),
                    RessourcesCreated = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ressources_CategoryId",
                table: "Ressources",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Ressources_StatisticId",
                table: "Ressources",
                column: "StatisticId");
